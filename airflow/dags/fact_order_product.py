...
# global var
db_table_name = 'order_product_stg'
dw_table_name = 'fact_order_product'
    ...
    def transform_and_load_task():
        ...
        with beam.Pipeline(options=options) as p:
            read_convert_remove = ( 
                ...
                | 'ConvertTypeFloatToDecimal' >> beam.ParDo(mo.ConvertFloatToDecimal(['unit_price','total_unit_price']))
