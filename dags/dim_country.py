...
# global var
db_table_name = 'country_location_stg'
dw_table_name = 'dim_country'
...
def elt_dim_product():
    ...
    def transform_and_load_task():
        ...
        with beam.Pipeline(options=options) as p:
            ...
            #     # | 'TransformData2' >> ParDo(ConvertTypeTwo())
            #     | 'RemoveDuplicates' >> mo.RemoveDuplicates(dedup_unique_key)
            #     # | 'Print Element Type' >> beam.ParDo(mo.PrintElementType())
